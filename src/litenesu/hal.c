...
{
	if (b == 0) {
		if (buttonValue & VPAD_BUTTON_HOME) {
			return 1;
		}
	} else if (b == 1) {
		if (buttonValue & VPAD_BUTTON_A) {
			return 1;
		}
	} else if (b == 2) {
		if (buttonValue & VPAD_BUTTON_B) {
			return 1;
		}
	} else if (b == 3) {
		if (buttonValue & VPAD_BUTTON_MINUS) {
			return 1;
		}
	} else if (b == 4) {
		if (buttonValue & VPAD_BUTTON_PLUS) {
			return 1;
		}
	} else if (b == 5) {
		if (buttonValue & VPAD_BUTTON_UP) {
			return 1;
		}
	} else if (b == 6) {
		if (buttonValue & VPAD_BUTTON_DOWN) {
			return 1;
		}
	} else if (b == 7) {
		if (buttonValue & VPAD_BUTTON_LEFT) {
			return 1;
		}
	} else if (b == 8) {
		if (buttonValue & VPAD_BUTTON_RIGHT) {
			return 1;
		}
	}
	if (buttonValue & VPAD_BUTTON_R) {
		if (drawFilter == 1) {
			drawFilter = 0;
		}
		else {
